...
![6.11](https://github.com/HouRuizhe/Pictures-of-experiments-summaries/blob/master/P6.11.png)

##### **Step3**：放大器区域调零 

用杜邦线将 Usc 两端接至 Vin 两端，用杜邦线将 Vout 两端连接至 AI+、AI-。

![6.12](file:///C:\Users\xiaoy\AppData\Local\Temp\ksohtml\wpsA4E6.tmp.png) 
